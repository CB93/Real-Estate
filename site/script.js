// ---------- Thumbnail fallback ----------
// Grid tiles load from images/thumbs/. If a thumb is missing, fall back to
// the full-size file so nothing ever breaks.
(function () {
...
(function () {
  ...
  // fetch the next/previous full-size photo while the current one is on screen
